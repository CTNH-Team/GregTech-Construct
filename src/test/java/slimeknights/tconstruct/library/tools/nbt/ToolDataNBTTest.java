...
class ToolDataNBTTest extends BaseMcTest {
  private static final ResourceLocation testKey = ResourceLocation.tryParse("test");
  private static final ResourceLocation testKey2 = ResourceLocation.tryParse("test2");
