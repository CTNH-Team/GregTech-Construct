...
public class JEIPlugin implements IModPlugin {
  ...
  /**
   * EMI owns the recipe viewer integration when present. JEI remains available as a fallback
   * for packs that do not include EMI, but must not register a second copy of the same content.
   */
  private static boolean isDisabledByEmi() {
