 ...
 */
public class BotaniaMaterialRecipeProvider extends BaseRecipeProvider
                                           implements IMaterialRecipeHelper, ISmelteryRecipeHelper {
    ...
    private void addBotaniaMetalMelting(Consumer<FinishedRecipe> consumer, FluidObject<?> fluid, String fluidName,
                                        String itemName) {
        ...
        MeltingRecipeBuilder
                .melting(ItemNameIngredient.from(botaniaId(itemName + "_block")), fluid, FluidValues.METAL_BLOCK)
