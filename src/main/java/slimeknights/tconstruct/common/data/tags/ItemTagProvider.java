...
public class ItemTagProvider extends ItemTagsProvider {
    ...
    private void addTools() {
        ...
        addToolTags(TinkerTools.HAMMER, MULTIPART_TOOL, DURABILITY, HARVEST_PRIMARY, STONE_HARVEST, MELEE_PRIMARY, INTERACTABLE_RIGHT, AOE, CLUSTER_MAX_HARVESTABLES, BROAD_TOOLS, BONUS_SLOTS, HAMMERS, CRAFTING_HAMMERS, ItemTags.PICKAXES);
