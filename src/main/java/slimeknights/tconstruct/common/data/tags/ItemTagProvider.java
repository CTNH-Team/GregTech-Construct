...
public class ItemTagProvider extends ItemTagsProvider {
    ...
    private void addTools() {
        ...
        //gt
        addToolTags(TinkerTools.wireCutter, MULTIPART_TOOL, DURABILITY, HARVEST_PRIMARY, MELEE_PRIMARY, INTERACTABLE_RIGHT, CLUSTER_MAX_HARVESTABLES, BROAD_TOOLS, BONUS_SLOTS, WIRE_CUTTERS, CRAFTING_WIRE_CUTTERS);
        // ranged
