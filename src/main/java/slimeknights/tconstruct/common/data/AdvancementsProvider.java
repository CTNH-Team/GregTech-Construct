...
public class AdvancementsProvider extends GenericDataProvider {
    ...
    protected void generate() {
        ...
        builder(TinkerSmeltery.hammerHeadCast, resource("smeltery/cast_collector"), goldCasting, FrameType.GOAL, builder -> {
            ...
            with.accept(TinkerSmeltery.wireCutterHeadCast);
            with.accept(TinkerSmeltery.fileHeadCast);
            with.accept(TinkerSmeltery.screwdriverHeadCast);
            with.accept(TinkerSmeltery.sawBladeCast);
            with.accept(TinkerSmeltery.crowbarHeadCast);
            with.accept(TinkerSmeltery.mortarHeadCast);
            with.accept(TinkerSmeltery.mortarBowlCast);
