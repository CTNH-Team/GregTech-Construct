...
import slimeknights.tconstruct.tools.modifiers.effect.TriggeredEffect;
...
public class TinkerEffects extends TinkerModule {
  ...
  public static final RegistryObject<TriggeredEffect> triggered = MOB_EFFECTS.register("triggered", TriggeredEffect::new);
