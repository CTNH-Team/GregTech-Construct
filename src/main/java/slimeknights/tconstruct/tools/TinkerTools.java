...
public final class TinkerTools extends TinkerModule {
    ...
    public static final ItemObject<ModifiableItem> file = ITEMS.register("file", () -> new ModifiableGTToolItem(UNSTACKABLE_PROPS, ToolDefinitions.FILE));
    ...
    public static final ItemObject<ModifiableItem> mortar = ITEMS.register("mortar", () -> new ModifiableGTToolItem(UNSTACKABLE_PROPS, ToolDefinitions.MORTAR));
