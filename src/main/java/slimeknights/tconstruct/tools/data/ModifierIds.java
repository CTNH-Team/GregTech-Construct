...
public class ModifierIds {
    ...
    public static final ModifierId meleeDefense = id("melee_defense");
    public static final ModifierId projectileDefense = id("projectile_defense");
    ...
    public static final ModifierId crystalLattice = id("crystal_lattice");
    public static final ModifierId crystalizing = id("crystalizing");
    public static final ModifierId crystalSolidity = id("crystal_solidity");
    public static final ModifierId totem = id("totem");
    public static final ModifierId recurrence = id("recurrence");
