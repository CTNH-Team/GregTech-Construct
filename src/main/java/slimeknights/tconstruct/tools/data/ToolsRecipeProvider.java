...
public class ToolsRecipeProvider extends BaseRecipeProvider implements IMaterialRecipeHelper, IToolRecipeHelper {
    ...
    private void addToolBuildingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        toolBuilding(consumer, TinkerTools.crowbar, folder);
        toolBuilding(consumer, TinkerTools.mortar, folder);
        // bow
    ...
    private void addPartRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        partRecipes(consumer, TinkerToolParts.crowbarHead,     TinkerSmeltery.crowbarHeadCast,     2, partFolder, castFolder);
        partRecipes(consumer, TinkerToolParts.mortarHead,      TinkerSmeltery.mortarHeadCast,      2, partFolder, castFolder);
        partRecipes(consumer, TinkerToolParts.mortarBowl,      TinkerSmeltery.mortarBowlCast,      4, partFolder, castFolder);
        ...
        // armor
        partWithDummy(consumer, TinkerToolParts.plating.get(ArmorItem.Type.HELMET),     TinkerSmeltery.dummyPlating.get(ArmorItem.Type.HELMET),     TinkerSmeltery.helmetPlatingCast,     2, partFolder, castFolder);
        partWithDummy(consumer, TinkerToolParts.plating.get(ArmorItem.Type.CHESTPLATE), TinkerSmeltery.dummyPlating.get(ArmorItem.Type.CHESTPLATE), TinkerSmeltery.chestplatePlatingCast, 3, partFolder, castFolder);
