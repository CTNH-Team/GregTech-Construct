...
public class ToolItemModelProvider extends AbstractToolItemModelProvider {
    ...
    protected void addModels() throws IOException {
        ...
        //gt
        tool(TinkerTools.wireCutter, toolBlocking, "head");
        tool(TinkerTools.wrench, toolBlocking, "head");
        tool(TinkerTools.file, toolBlocking, "head");
        ...
        tool(TinkerTools.mortar, toolBlocking, "head");
        // scythe
        ...
        shield("plate", TinkerTools.plateShield, readJson(getResource("base/shield_large_blocking")), "plating", "cast");
        // misc
