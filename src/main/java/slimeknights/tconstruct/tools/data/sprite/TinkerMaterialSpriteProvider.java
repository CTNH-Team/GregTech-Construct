...
public class TinkerMaterialSpriteProvider extends AbstractMaterialSpriteProvider {
    ...
    protected void addAllMaterials() {
        ...
        buildMaterial(IMaterial.UNKNOWN_ID)
                ...
                .statType(StatlessMaterialStats.SHIELD_CORE, StatlessMaterialStats.CUIRASS)
                .statType(ArmorPartMaterialStats.MAILLE)
                .statType(ArmorPartMaterialStats.ARMOR_LAYER_PLATE, ArmorPartMaterialStats.ARMOR_LAYER_MAIL, ArmorPartMaterialStats.MAILLE)
                .statType(ArmorPartMaterialStats.CORE_TYPES).statType(ArmorPartMaterialStats.FRAME_TYPES).statType(ArmorPartMaterialStats.HEAVY_CORE_TYPES)
        ...
        buildMaterial(MaterialIds.ice)
                ...
                .transformer(GreyToSpriteTransformer.builderFromBlack()
                        .addTexture(63, ResourceLocation.tryParse("block/blue_ice"))
                        .addTexture(102, ResourceLocation.tryParse("block/packed_ice"))
                        .addTexture(140, ResourceLocation.tryParse("block/ice"))
                        .build());
        ...
        buildMaterial(MaterialIds.iron)
                .meleeHarvest().armor()
                .statType(ArmorPartMaterialStats.ARMOR_LAYER_PLATE)
                .statType(ArmorPartMaterialStats.ARMOR_LAYER_MAIL)
                .statType(ArmorPartMaterialStats.CORE_TYPES)
                .statType(ArmorPartMaterialStats.FRAME_TYPES)
                .statType(ArmorPartMaterialStats.HEAVY_CORE_TYPES)
        ...
        buildMaterial(MaterialIds.silver)
                ...
                .statType(ArmorPartMaterialStats.CORE_TYPES)
                .statType(ArmorPartMaterialStats.FRAME_TYPES)
                .statType(ArmorPartMaterialStats.HEAVY_CORE_TYPES).statType(INGOT)
                .fallbacks("metal")
        ...
        buildMaterial(MaterialIds.slimeskin).fallbacks("cloth").statType(StatlessMaterialStats.BOWSTRING).cuirass().maille().armorLinear().colorMapper(greenSlime);
        ...
        buildMaterial(MaterialIds.steel)
                ...
                .statType(ArmorPartMaterialStats.CORE_TYPES)
                .statType(ArmorPartMaterialStats.FRAME_TYPES)
                .statType(ArmorPartMaterialStats.HEAVY_CORE_TYPES).arrowHead()
                .fallbacks("metal")
        ...
        buildMaterial(MaterialIds.bronze)
                ...
                .statType(ArmorPartMaterialStats.CORE_TYPES)
                .statType(ArmorPartMaterialStats.FRAME_TYPES)
                .statType(ArmorPartMaterialStats.HEAVY_CORE_TYPES).statType(INGOT, STORAGE_BLOCK)
                .fallbacks("metal")
        ...
        buildMaterial(MaterialIds.steeleaf)
                ...
                .statType(ArmorPartMaterialStats.CORE_TYPES)
                .statType(ArmorPartMaterialStats.FRAME_TYPES)
                .statType(ArmorPartMaterialStats.HEAVY_CORE_TYPES).arrowHead().statType(INGOT)
        ...
        buildMaterial(MaterialIds.queensSlime)
                ...
                .fallbacks("slime_metal", "metal")
                .transformer(GreyToSpriteTransformer.builderFromBlack()
                        .addTexture( 63, borderTexture,    0xFFC8C8C8)
                        .addTexture(102, borderTexture)
                        .addTexture(140, baseTexture,      0xFFE1E1E1)
                        .addTexture(178, baseTexture)
                        .addTexture(216, highlightTexture, 0xFFE1E1E1)
                        .addTexture(255, highlightTexture)
                        .build());
        ...
        buildMaterial(MaterialIds.obsidian).armor()
                .statType(ArmorPartMaterialStats.ARMOR_LAYER_PLATE)
                .statType(ArmorPartMaterialStats.ARMOR_LAYER_MAIL)
                .statType(ArmorPartMaterialStats.CORE_TYPES)
                .statType(ArmorPartMaterialStats.FRAME_TYPES)
                .statType(ArmorPartMaterialStats.HEAVY_CORE_TYPES)
                .fallbacks("rock").colorMapper(obsidianPalette);
...
//    buildMaterial(MaterialIds.uranium).fallbacks("metal").colorMapper(uraniumPalette);
        ...
        for (DyeColor color : DyeColor.values()) {
            ...
            builder.arrowHead().statType(StatlessMaterialStats.LINEAR).statType(ArmorPartMaterialStats.MAILLE).transformer(transformerFromSprite(ResourceLocation.tryParse("block/" + name + "_wool"), 0, 0));
        ...
        buildMaterial(MaterialIds.magma) // note the non-standard gray values, as we are targeting the slime armor directly
        ...
        buildMaterial(MaterialIds.ichorskin).fallbacks("cloth").cuirass().maille().armorLinear().colorMapper(ichor);
