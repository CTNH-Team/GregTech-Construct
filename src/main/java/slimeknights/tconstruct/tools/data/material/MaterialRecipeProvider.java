...
public class MaterialRecipeProvider extends BaseRecipeProvider implements IMaterialRecipeHelper {
    ...
    private void addMaterialItems(Consumer<FinishedRecipe> consumer) {
        ...
        metalMaterialRecipe(consumer, MaterialIds.manaSteel, folder, "mana_steel", true);
        ...
        metalMaterialRecipe(consumer, MaterialIds.terraSteel, folder, "terra_steel", true);
    ...
    private void addMaterialSmeltery(Consumer<FinishedRecipe> consumer) {
        ...
        compatMeltingCasting(consumer, MaterialIds.terraSteel, TinkerFluids.moltenTerraSteel, "terrasteel", folder);
