...
public class SmelteryRecipeGenerator implements ISmelteryRecipeHelper, ICommonRecipeHelper {
    ...
    public static void register(Consumer<FinishedRecipe> consumer) {
        ...
        generator.addCompatRecipes(consumer);
    }
