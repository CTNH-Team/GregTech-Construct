...
public class GTConstructRecipes {
  ...
  private static final List<SolidifierPart> DEFAULT_SOLIDIFIER_PARTS = List.of(
    new SolidifierPart("repair_kit", TinkerToolParts.repairKit, 2, TinkerSmeltery.repairKitCast, MATERIAL_SUPPORT::hasRepairKitSupport),
    new SolidifierPart("pick_head", TinkerToolParts.pickHead, 2, TinkerSmeltery.pickHeadCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID)),
    new SolidifierPart("hammer_head", TinkerToolParts.hammerHead, 8, TinkerSmeltery.hammerHeadCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID)),
    new SolidifierPart("small_axe_head", TinkerToolParts.smallAxeHead, 2, TinkerSmeltery.smallAxeHeadCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID)),
    new SolidifierPart("broad_axe_head", TinkerToolParts.broadAxeHead, 8, TinkerSmeltery.broadAxeHeadCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID)),
    new SolidifierPart("small_blade", TinkerToolParts.smallBlade, 2, TinkerSmeltery.smallBladeCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID)),
    new SolidifierPart("broad_blade", TinkerToolParts.broadBlade, 8, TinkerSmeltery.broadBladeCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID)),
    new SolidifierPart("bow_limb", TinkerToolParts.bowLimb, 2, TinkerSmeltery.bowLimbCast, material -> MATERIAL_SUPPORT.hasStat(material, LimbMaterialStats.ID)),
    new SolidifierPart("bow_grip", TinkerToolParts.bowGrip, 2, TinkerSmeltery.bowGripCast, material -> MATERIAL_SUPPORT.hasStat(material, GripMaterialStats.ID)),
    new SolidifierPart("tool_binding", TinkerToolParts.toolBinding, 1, TinkerSmeltery.toolBindingCast, material -> MATERIAL_SUPPORT.hasStat(material, StatlessMaterialStats.BINDING.getIdentifier())),
    new SolidifierPart("tough_binding", TinkerToolParts.toughBinding, 3, TinkerSmeltery.toughBindingCast, material -> MATERIAL_SUPPORT.hasStat(material, StatlessMaterialStats.BINDING.getIdentifier())),
    new SolidifierPart("adze_head", TinkerToolParts.adzeHead, 2, TinkerSmeltery.adzeHeadCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID)),
    new SolidifierPart("large_plate", TinkerToolParts.largePlate, 4, TinkerSmeltery.largePlateCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID)),
    new SolidifierPart("tool_handle", TinkerToolParts.toolHandle, 1, TinkerSmeltery.toolHandleCast, material -> MATERIAL_SUPPORT.hasStat(material, HandleMaterialStats.ID)),
    new SolidifierPart("tough_handle", TinkerToolParts.toughHandle, 3, TinkerSmeltery.toughHandleCast, material -> MATERIAL_SUPPORT.hasStat(material, HandleMaterialStats.ID)),
    ...
    new SolidifierPart("maille", TinkerToolParts.maille, 2, TinkerSmeltery.mailleCast, material -> MATERIAL_SUPPORT.hasStat(material, StatlessMaterialStats.MAILLE.getIdentifier())),
    new SolidifierPart("armor_plate", TinkerToolParts.armorPlate, 2, TinkerSmeltery.armorPlateCast, material -> MATERIAL_SUPPORT.hasStat(material, ArmorExtensionMaterialStats.ARMOR_PLATE.getId())),
    new SolidifierPart("armor_mail", TinkerToolParts.armorMail, 1, TinkerSmeltery.armorMailCast, material -> MATERIAL_SUPPORT.hasStat(material, ArmorExtensionMaterialStats.ARMOR_MAIL.getId())),
    ...
    new SolidifierPart("linear", TinkerToolParts.linear, 2, TinkerSmeltery.linearCast, material -> MATERIAL_SUPPORT.hasStat(material, StatlessMaterialStats.LINEAR.getIdentifier())),
    // gt tool heads
    new SolidifierPart("wrench_head", TinkerToolParts.wrenchHead, 2, TinkerSmeltery.wrenchHeadCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID)),
    new SolidifierPart("wire_cutter_head", TinkerToolParts.wireCutterHead, 2, TinkerSmeltery.wireCutterHeadCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID)),
    new SolidifierPart("file_head", TinkerToolParts.fileHead, 2, TinkerSmeltery.fileHeadCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID)),
    new SolidifierPart("screwdriver_head", TinkerToolParts.screwdriverHead, 2, TinkerSmeltery.screwdriverHeadCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID)),
    new SolidifierPart("saw_blade", TinkerToolParts.sawBlade, 2, TinkerSmeltery.sawBladeCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID)),
    new SolidifierPart("crowbar_head", TinkerToolParts.crowbarHead, 2, TinkerSmeltery.crowbarHeadCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID)),
    new SolidifierPart("mortar_head", TinkerToolParts.mortarHead, 2, TinkerSmeltery.mortarHeadCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID)),
    new SolidifierPart("mortar_bowl", TinkerToolParts.mortarBowl, 2, TinkerSmeltery.mortarBowlCast, material -> MATERIAL_SUPPORT.hasStat(material, HeadMaterialStats.ID))
  );
